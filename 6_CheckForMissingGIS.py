...
for group in alpha_group:
    ...
    arcpy.env.workspace = regionsDIR
    workspaces = arcpy.ListWorkspaces("*", "FileGDB")
    # for each group count the number of species in each region and generate a dict Birds: ['number in regions A',
    # 'number in region b' etc. Then for each group loop through workspace count the number of files in gdb and see if
    # it matches
